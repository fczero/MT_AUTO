...
errorhandler_BtnClick(ControlName, ControlText, ExpectedText, windowTitleName, windowClassName) {

    logger_log("Button Click: " . ControlName . " - " .  windowTitleName )
    retryCount := 0
    
    BlockInput, On
    ControlGetText, ButtonText, %ControlText% , %windowClassName%
    loop,
    {
        ...
        Else
        {
            ControlFocus, %ControlText% , %windowTitleName% %windowClassName%
            ControlClick, %ControlText% , %windowClassName% 
            ControlGetText, ButtonText, %ControlName% , %windowClassName%
